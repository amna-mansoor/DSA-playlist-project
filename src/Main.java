...
//    private SongStack undoStack= new SongStack();
...
//            System.out.println(root.song.name + "  ");
...
Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            dateAdded = sdf.parse("2023-11-11");
        ...
        try {
            releaseDate = sdf.parse("2015-4-14");
            dateAdded = sdf.parse("2023-11-11");
        } catch (ParseException e) {
            e.printStackTrace();
        }
...
//        AVLtree tree = new AVLtree();
        ...
        if ((userName.equalsIgnoreCase("Faiza") && password.equalsIgnoreCase("Khan")) || (userName.equalsIgnoreCase("Alizah") && password.equalsIgnoreCase("Basit")) ||  (userName.equalsIgnoreCase("Amna") && password.equalsIgnoreCase("Mansoor"))){
            ...
            do {
                ...
                switch (choice) {
                    case 1:
                        ...
                        System.out.println("Enter the indices of the songs for your playlist. Type 'done' when finished:");
...
//playlist to a file with username+playlist name
                    ...
                    case 3:
                        ...
                        if (selectedQueue != null) {
                            ...
                            switch (playChoice) {
                                ...
                                case 5:
                                    if (selectedQueue != null) {
                                        System.out.println("Enter the song number to play next:");
...
//                                    loadedPlayList.undo();
//                                    while(loadedPlayList.front!=null) {
//                                        loadedPlayList2.enqueue(loadedPlayList.front.data);
//                                        loadedPlayList.dequeue();
//                                    }
//                                    loadedPlayList2.dequeue();
//                                    while(loadedPlayList2.front!=null) {
//                                        loadedPlayList.enqueue(loadedPlayList2.front.data);
//                                        loadedPlayList2.dequeue();
//                                    }
//                                    loadedPlayList.undo();
...
////                                try (ObjectInputStream in = new ObjectInputStream(new FileInputStream(file))) {
//////                                    ArrayList<Songs> loadedPlaylist = (ArrayList<Songs>) in.readObject();
////                                        loadedPlayList=(Queue) in.readObject();
////
////
////                                    // Display the songs in the loaded playlist
//////                                    loadedPlayList.pop()
